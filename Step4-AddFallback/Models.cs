...
public class ObservationStore
{
    ...
    {
        return _observations.FirstOrDefault(o => o.ObservationId == observationId);
    }
    ...
    {
        return _observations.Where(o => o.Labeled).ToList();
    }
}
...
public class ModelService
{
    ...
    public void TrainInitialModel()
    {
        ...
        Log.Information("Initial model trained with version {Version}", _version);
    }
...
// TASK 1: Add FallbackService for graceful degradation
// Uncomment the entire FallbackService class below:
